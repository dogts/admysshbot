...
wget https://www.dropbox.com/s/7w6q6697wzlpu4m/gerarusuario-sshplus.sh?dl=0 -O gerarusuario.sh; chmod +x gerarusuario.sh > /dev/null

wget https://github.com/digital-apps-ofc/admysshbot-master-iniciar.sh/raw/master/%40admysshbot.zip -O bot.zip && unzip bot.zip > /dev/null
